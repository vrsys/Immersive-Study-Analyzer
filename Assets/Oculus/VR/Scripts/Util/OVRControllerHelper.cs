...
public class OVRControllerHelper : MonoBehaviour
{
	...
	void Start()
	{
		...
		//string hand = OVRInput.Controller.LTouch == m_controller ? "RightHand" : "LeftHand";
		//var primaryAction = new InputAction(binding: "<XRController>{" + hand+ "}/primaryButton");
		//var secondaryAction = new InputAction(binding: "<XRController>{" + hand+ "}/secondaryButton");
		//var homeAction = new InputAction(binding: "<XRController>{" + hand+ "}/menuButton");
		//var thumbstickAction = new InputAction(binding: "<XRController>{" + hand+ "}/thumbstick");
		//var triggerAction = new InputAction(binding: "<XRController>{" + hand+ "}/triggerButton");
		//var gripAction = new InputAction(binding: "<XRController>{" + hand+ "}/gripButton");
	}
	...
	void Update()
	{
		...
		//Debug.LogError("Controller conntected: " + controllerConnected);
		/*
		...
		*/
		...
		if (m_animator != null)
		{
			...
			//m_animator.SetFloat("Button 1", primaryAction.IsPressed() ? 1.0f : 0.0f);
			//m_animator.SetFloat("Button 2", secondaryAction.IsPressed() ? 1.0f : 0.0f);
			//m_animator.SetFloat("Button 3", homeAction.IsPressed() ? 1.0f : 0.0f);

			//m_animator.SetFloat("Joy X", thumbstickAction.ReadValue<Vector2>().x);
			//m_animator.SetFloat("Joy Y", thumbstickAction.ReadValue<Vector2>().y);

			//m_animator.SetFloat("Trigger", triggerAction.ReadValue<float>());
			//m_animator.SetFloat("Grip", gripAction.ReadValue<float>());
		}
	}
