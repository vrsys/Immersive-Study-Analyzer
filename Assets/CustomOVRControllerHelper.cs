...
public class CustomOVRControllerHelper : MonoBehaviour
{
	...
	void Start()
	{
		...
		string hand = OVRInput.Controller.LTouch == m_controller ? "LeftHand" : "RightHand";
		primaryAction = new InputAction(binding: "<XRController>{" + hand+ "}/primaryButton");
		secondaryAction = new InputAction(binding: "<XRController>{" + hand+ "}/secondaryButton");
		homeAction = new InputAction(binding: "<XRController>{" + hand+ "}/start");
		thumbstickAction = new InputAction(binding: "<XRController>{" + hand+ "}/thumbstick");
		triggerAction = new InputAction(binding: "<XRController>{" + hand+ "}/trigger");
		gripAction = new InputAction(binding: "<XRController>{" + hand+ "}/grip");
	...
	void Update()
	{
		...
		*/
		...
		if (m_animator != null)
		{
			...
			//Debug.Log("PrimaryPressed: " + primaryAction.IsPressed());
